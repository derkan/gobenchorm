...
import (
	...
	"github.com/derkan/gobenchorm/benchs"
...
func main() {
	...
	flag.StringVar(&benchs.ORM_SOURCE, "source", "host=localhost port=5432 user=bench password=pass dbname=benchdb sslmode=disable", "postgres dsn source")
